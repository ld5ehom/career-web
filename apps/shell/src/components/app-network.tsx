...
export default function AppNetwork() {
    // Create a reference to the wrapper div for the app-network micro app
    // app-network 마이크로 앱을 위한 wrapper div 참조 생성
    ...
    // Listen for shell events and handle navigation for app-network
    // app-network의 네비게이션을 처리하기 위해 shell 이벤트 리스닝
    ...
    // Render the div that will contain the app-network micro app
    // app-network 마이크로 앱을 포함할 div를 렌더링
