...
import inject from "jobs/injector";
...
export default function AppJobs() {
    // Create a reference to the wrapper div for the app-jobs micro app
    // app-jobs 마이크로 앱을 위한 wrapper div 참조 생성
    ...
    // Listen for shell events and handle navigation for app-jobs
    // app-jobs의 네비게이션을 처리하기 위해 shell 이벤트 리스닝
    useShellEvent("app-jobs", appJobsBasename);
    ...
    // Render the div that will contain the app-jobs micro app
    // app-jobs 마이크로 앱을 포함할 div를 렌더링
