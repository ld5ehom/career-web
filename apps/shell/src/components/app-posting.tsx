...
import inject from "posting/injector"; // Import the injector function for injecting the micro app(tsconfig.json 31 line)
...
export default function AppPosting() {
    // Create a reference to the wrapper div for the app-posting micro app
    // app-posting 마이크로 앱을 위한 wrapper div 참조 생성
    ...
    // Listen for shell events and handle navigation for app-posting
    // app-posting의 네비게이션을 처리하기 위해 shell 이벤트 리스닝
    ...
    // Render the div that will contain the app-posting micro app
    // app-posting 마이크로 앱을 포함할 div를 렌더링
